...
**This will only work for Sonoff devices running V3+ of the stock (Itead / eWeLink) firmware. For users of V1.8.0 - V2.6.1, please use the `PySonoffLAN package <https://pypi.org/project/pysonofflan/>`_**
